...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | ESC  | LCtrl| LAlt | SYMB | META | LGUI |Space |   | Enter| RGUI | SYMB | Left |  Up  | Down | Right|
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [BASE] = LAYOUT( \
    ...
    KC_ESC,  KC_LCTL, KC_LALT,  MO(SYMB), MO(META), KC_LGUI, KC_SPC,     KC_ENT,  KC_RGUI, MO(SYMB), KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT \
  ),
